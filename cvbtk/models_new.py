...
class LeftVentricleModel(object):
    ...
    def estimate_displacement(self):
        ...
        u_old_array = self.u_old.vector().get_local()
        u_old_old_array = self.u_old_old.vector().get_local()
...
class FiberReorientation(object):
    ...
    def __init__(self, model, inputs):
        ...
        self._on_boundary = interpolate(on_boundary_func, Q).vector().get_local()
