...
dir_out = '/mnt/c/Users/Maaike/Documents/Master/Graduation_project/meshes'
...
print('save to hdf5')
lv.save_mesh_to_hdf5(os.path.join(dir_out,'{}_mesh.hdf5'.format(mesh_name)),
...
h5file = HDF5File(comm, os.path.join(dir_out,'{}_mesh.hdf5'.format(mesh_name)), 'r')
h5file.read(mesh, 'mesh', True) #read hdf5 file and store the mesh as a variable
with XDMFFile(comm, os.path.join(dir_out,'{}_mesh.xdmf'.format(mesh_name))) as f:
    f.write(mesh)
